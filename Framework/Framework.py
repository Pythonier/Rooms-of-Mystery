# Framework for Rooms of Mystery - This is done being edited.  The updates are continuing in the respected Concept (number).
...
def room_one():
    global itemOne, itemTwo, itemThree, itemFour
